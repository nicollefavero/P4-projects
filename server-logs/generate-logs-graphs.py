...
def main():
    ...
    plt.legend(["Baseline (2 requests per burst)", "QUIC-Tr4ck (2 requests per burst)", "Baseline (4 requests per burst)", "QUIC-Tr4ck (4 requests per burst)"], loc="upper right")
    ...
    plt.savefig("s2s4-c4-t1_0-MEM.pdf")
    plt.show()
